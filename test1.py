...
if(t==0):
    ...
    drop5 = OptionMenu( window , clicked5 , *options5 )
    ...
    lbl6 = tk.Label(window, text = "Up / Up and Down")
    ...
    lbl6.grid(column = 1, row = 15, padx=5, pady=5)
    drop5.grid(column = 1,row = 17, padx=5, pady=5)
    
    lbl4.grid(column = 1, row = 19, padx=5, pady=5)
    inputtxt4.grid(column = 1,row = 21, padx=5, pady=5)
    lbl5.grid(column = 1, row = 24, padx=5, pady=5)
    drop4.grid(column = 1,row = 26, padx=5, pady=5)
    button_start.grid(column = 1,row = 30, padx=5, pady=5)
